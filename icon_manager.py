"""
Icon management functionality for REMOTE application.
"""
# pylint: disable=no-name-in-module, import-error, trailing-whitespace, invalid-name

import os

def create_default_icons(icons_dir):
    ...
    # Write the SVG files
    icon_files = {
        "calendar.svg": calendar_svg,
        "slack.svg": slack_svg,
        "email.svg": email_svg,
        "expand.svg": expand_svg,
        "collapse.svg": collapse_svg
    }
